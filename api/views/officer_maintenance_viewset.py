...
from api.serializers import OfficerMaintenanceSerializer
...
class OfficerMaintenanceViewSet(viewsets.ModelViewSet):
    queryset = OfficerMaintenance.objects.all().order_by('id')
    serializer_class = OfficerMaintenanceSerializer
